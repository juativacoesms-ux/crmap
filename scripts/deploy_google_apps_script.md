# Publicar correção da planilha (Google Apps Script)

O site e o Supabase já enviam os eventos corretos, mas a **lógica de upsert na planilha** só vale depois de publicar o `google_apps_script.gs`.
